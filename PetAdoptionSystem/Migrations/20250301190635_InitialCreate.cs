    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdoptionHistories", x => x.HistoryId);
                    table.ForeignKey(
                        name: "FK_AdoptionHistories_Pets_PetId",
                        column: x => x.PetId,
                        principalTable: "Pets",
                        principalColumn: "PetId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdoptionHistories_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdoptionHistories_PetId",
                table: "AdoptionHistories",
                column: "PetId");

            migrationBuilder.CreateIndex(
                name: "IX_AdoptionHistories_UserId",
                table: "AdoptionHistories",
                column: "UserId");
